...
const WalletTransactions = () => {
  const request = `
  curl --location 'https://oapi.pursfinance.com/api/v1/live-central/wallet/1/transactions' 
      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="overflow-hidden">
            <CopyBlock
              text={`https://oapi.pursfinance.com/api/v1/live-central/wallet/:walletId/transactions`}
              language="text"
