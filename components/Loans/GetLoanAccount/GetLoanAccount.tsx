...
const GetLoanAccount = () => {
  const request = `
  curl --location 'https://oapi.pursfinance.com/api/v1/live-central/loans/0307dd219df34dd9ae703dc873851f95/account' 
--header 'x-api-key: test_eyJuYW1lIjoiYXV0aGVudGljIiwiaXNfYWN0aXZlIjp0cnVlLCJjcmVhdGVkX2F0IjoiMjAyNC0wNS0wMlQwODozMDowOC45NTg2MzUiLCJ1cGRhdGVkX2F0IjoiMjAyNC0wNS0wMlQwODozMDowOC45NTg2NTIiLCJzZXJ2aWNlX2lkIjoxLCJ1c2VyX2lkIjoxLCJzZXJ2aWNlX25hbWUiOiJsb2FuX3NlcnZpY2UifQ'
  ...
  const response = `
  {
    ...
    "data": {
      "id": 1,
      "account_number": "9260375795",
      "bank_code": "000023",
      "bank_name": "Providus",
      "account_name": "Payaza (Peter Edoka)"
    },
    "status": 200
  }
  `;
      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="overflow-hidden">
            <CopyBlock
              text={`https://oapi.pursfinance.com/api/v1/live-central/loans/:loan_reference/account`}
              language="text"
