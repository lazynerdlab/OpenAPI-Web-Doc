...
const GetLoanBalance = () => {
  const request = `
  curl --location 'https://oapi.pursfinance.com/api/v1/live-central/loans/0307dd219df34dd9ae703dc873851f95/balance' 
      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="overflow-hidden">
            <CopyBlock
              text={`https://oapi.pursfinance.com/api/v1/live-central/loans/:loan_reference/balance`}
              language="text"
