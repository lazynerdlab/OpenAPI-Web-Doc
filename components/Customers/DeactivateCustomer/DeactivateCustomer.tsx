...
const DeactivateCustomer = () => {
  const request = `
  curl --location --request POST 'https://oapi.pursfinance.com/api/v1/live-central/customers/663b58f06f873545cfd44fe9/deactivate' 
...
--data ''
  ...
  const response = `
  {
    ...
    "data": {
      ...
      "updatedAt": "2024-05-08T10:54:18.568Z",
      "__v": 0
    },
    "status": 200
  }
      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="overflow-hidden">
            <CopyBlock
              text={`https://oapi.pursfinance.com/api/v1/live-central/customers/:customer_id/deactivate`}
              language="text"
