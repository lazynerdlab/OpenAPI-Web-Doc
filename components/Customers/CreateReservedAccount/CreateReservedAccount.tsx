...
const CreateReservedAccount = () => {
  const request = `
  curl --location 'https://oapi.pursfinance.com/api/v1/live-central/accounts/reserved' 
--data '{}'
  `;
    ...
    <main className="flex max-h-screen max-w-[800px] overflow-y-scroll flex-col justify-between p-4 md:p-8">
      <div className="flex flex-col gap-8">
        ...
        <div className="flex flex-col gap-4">
          ...
          <CopyBlock
            text={`https://oapi.pursfinance.com/api/v1/live-central/accounts/reserved`}
            language="text"
...
export default CreateReservedAccount;
